...
class HDMTestCase(TestCase):
    ...
    os.environ['HDM_HOME'] = os.path.abspath(os.path.join(local_path, '../../../Desktop/hashmap_data_migrator/tests/test_assets'))
    os.environ['HDM_ENV'] = 'unit-test'
    os.environ['HDM_DATA_STAGING'] = os.path.abspath(os.path.join(local_path, 'test_assets2/data_staging'))
    os.environ['HDM_MANIFESTS'] = os.path.abspath(os.path.join(local_path, '../../../Desktop/hashmap_data_migrator/tests/test_assets/manifests'))
    ...
    def set_environment_variables():
        conf_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../../Desktop/hashmap_data_migrator/tests/test_assets'))
